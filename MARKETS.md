...
`SPEC.md`. The lens throughout: a US individual, retail latency
...
(`SPEC.md`, time-series carve-out). Name one US execution venue and
...
**The $0 data spine** (the free-tier spine): one keyed pair —
